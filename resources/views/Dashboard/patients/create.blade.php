...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">{{__('patient.patients')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0"> {{__('patient.add_patient')}}</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
                ...
                <form action="{{route('patients.store')}}" method="post" autocomplete="off">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input class="form-control fc-datepicker" name="date_birth" placeholder="YYYY-MM-DD" value="{{old('date_birth')}}"
                             type="text" required>
                        </div>
                    ...
                    <br>
                        ...
                        @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties )
                            <div class="form-group">
                                ...
                                <textarea  name="{{ $localeCode }}[address]" class="form-control" >{{ old($localeCode . '.address') }}</textarea>
                            </div>
                        @endforeach
