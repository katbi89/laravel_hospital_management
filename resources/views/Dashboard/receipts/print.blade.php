                    ...
                    <div class="card-body">
                        ...
                        <div class="row mg-t-20">
                            <div class="col-md">
                                ...
                                <p class="invoice-info-row"><span>تاريخ الاصدار</span> <span>{{$receipt_account->date}}</span>
                                </p>
                                <p class="invoice-info-row "><span>اسم المريض</span>
                                    <span>{{$receipt_account->patients->name}}</span></p>
                            </div>
                        </div>
                        <div class="table-responsive mg-t-40">
                            <table class="table table-invoice border text-md-nowrap mb-0">
                                ...
                                <tr>
                                    <td>1</td>
                                    <td class="tx-12">{{ $receipt_account->description}}</td>
                                    <td class="tx-center">{{ number_format($receipt_account->amount,2)}}</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
